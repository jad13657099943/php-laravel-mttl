            ...
            <div class="layui-card-body">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="username" value="{{$user->username}}" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select id="admin_id" name="interest" lay-filter="aihao">
                            <option value="{{$user->admin_id}}">{{$name}}</option>
    ...
    <script>
        layui.use(['tree', 'util'], function() {
            var $ = layui.$
                ...
                , util = layui.util
            $('#add').click(function () {
                var url='{{route('m.user.api.admin.api.account.edit')}}?id='+{{$user->id}};
