...
namespace Modules\Web3\Components\TronAPI;

use Elliptic\EC;
use IEXBase\TronAPI\TronAddress;
use Modules\Web3\Components\TronAPI\Support\Base58;
use Modules\Web3\Components\TronAPI\Support\Base58Check;
use Modules\Web3\Components\TronAPI\Support\Crypto;
use Modules\Web3\Components\TronAPI\Support\Hash;
use Modules\Web3\Components\TronAPI\Support\Keccak;
use Modules\Web3\Components\TronAPI\Support\Utils;
use Modules\Web3\Components\TronAPI\Provider\HttpProviderInterface;
...
//        $routeParams = implode('/', $routeParams);
        return $this->manager->request("v1/contracts/{$contractAddress}/events", $routeParams, "get");
    }
