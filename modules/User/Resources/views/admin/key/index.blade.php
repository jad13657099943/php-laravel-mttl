...
@push('after-scripts')
    ...
    <script>
        layui.use(['form', 'table', 'util', 'laydate'], function () {
            ...
            table.render({
                elem: '#lay-table',
                url: '{{ route('m.user.api.admin.api.key.index') }}',
                ...
                cols: [[
                    ...
                    {field: 'api', title: 'API Key', width: 450},
                    {field: 'secret', title: 'Secret Key', width: 450},
                    {field: 'status_text', title: '状态', width: 150},
                    {field: 'key_text', title: '权限', width: 150},
                    {
                        field: 'created_at', title: '提交时间', width: 270, templet: function (res) {
            ...
            $('#edit_status').click(function(){
                layer.open({
                    ...
                    content:  '<div class="layui-inline">'+
                        ...
                        '<div class="layui-inline">'+
                        '<select id="status" class="layui-input" lay-filter="aihao" style="width: 150px">'+
                        '<option value="1">尚未激活</option>'+
                        '<option value="2">处理中</option>'+
                        '<option value="3">已经激活</option>'+
                        '</select>'+
                        '</div>'+
                        '</div>'
                    ,btn: ['确定']
