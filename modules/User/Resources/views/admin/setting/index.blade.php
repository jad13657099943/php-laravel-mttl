            ...
            <form method="post" class="layui-form" action="{{route('m.user.admin.setting.update')}}">
                ...
                <div class="layui-tab">
                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item">
                            <x-t-config-form :list="$configList3"></x-t-config-form>
                        </div>
                        <div class="layui-tab-item">
                            <x-t-config-form :list="$configList4"></x-t-config-form>
                        </div>
                        <div class="layui-tab-item">
                            <x-t-config-form :list="$configList5"></x-t-config-form>
                        </div>
                    </div>
                </div>
