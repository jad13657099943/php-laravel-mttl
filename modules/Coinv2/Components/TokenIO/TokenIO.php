...
namespace Modules\Coinv2\Components\TokenIO;

use InvalidArgumentException;
use Modules\Coinv2\Components\TokenIO\Exceptions\SignatureVerifyException;
use Modules\Coinv2\Components\TokenIO\Traits\HasApiMethod;
use Modules\Coinv2\Components\TokenIO\Traits\HasHttpRequest;
...
class TokenIO
{
     ...
     * @var string
     */
    protected $host = 'http://8.135.118.26';
    /**
     * @var string
     */
    protected $key;
