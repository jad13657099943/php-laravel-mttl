...
{{--                                <option @if($data->types == $key) selected @endif value="{{ $key }}">{{ $vo }}</option>--}}
{{--                            @endforeach--}}
{{--                        </select>--}}
{{--                    </div>--}}
{{--                </div>--}}
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="number" name="principal" value="{{$data->principal}}"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="checkbox" name="buyable_level[0]" @if(isset($data->buyable_level[0])) checked
                               @endif title="平民">
                        <input type="checkbox" name="buyable_level[1]" @if(isset($data->buyable_level[1])) checked
                               @endif title="精神领袖">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="number" name="daily_rate" value="{{$data->daily_rate}}"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="checkbox" name="enable" @if($data->enable == 1) checked @endif lay-skin="switch">
                    </div>
                </div>
    ...
    <script>
        layui.use(['form', 'table', 'layedit', 'laydate'], function () {
            ...
            form.on('submit(add)', function (data) {
                var url = '{{ route('m.mttl.api.admin.card.edit') }}';
