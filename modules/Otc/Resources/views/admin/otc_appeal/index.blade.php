    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <div class="test-table-reload-btn" style="margin-bottom: 10px;">
                ...
                <div class="layui-inline">
                    <select name="user_type" xm-select="user_type" id="user_type" lay-filter="user_type"
                            lay-verify="required" class="layui-select">
                        <option value="">--买卖会员--</option>
                        @foreach ($userType as $key=> $vo)
        ...
        <script>
            layui.use(['form', 'table', 'util','laydate'], function () {
                ...
                table.render({
                    ...
                    url: '{{ route('m.otc.api.admin.api.appeal.index') }}',
                    method:'get',
                    ...
                    cols: [[
                        ...
                        ,{field:'user_name', title: '申诉会员', width:120,event:'show_user'}
                        ,{field:'otc_trade_id', title: '撮合订单号', width:100,}
                        ,{field:'no', title: '交易投诉记录', width:200,}
                        ,{field:'user_type_text', title: '申诉用户身份', width:120, }
                        ,{field:'type_text', title: '撮合单类型', width:100, }
                        ,{field:'reason', title: '申诉措辞', }
                        ,{field:'handle', title: '处理说明', }
                        ,{field:'status_text', title: '处理结果', width:100, }
                ...
                var events = {
                    ...
                    edit:function (obj_data) {
                        var url = '{{ route('m.otc.admin.otc.appeal.edit') }}?id='+obj_data.id;
                        layer.open({
                            type: 2
                            , title: "查看处理申诉ID【"+obj_data.id+"】"
                            , content: url
                            , area: ['90%', '90%']
                        })
                    },
