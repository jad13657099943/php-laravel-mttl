...
namespace Modules\Web3\Components\Web3;

use InvalidArgumentException;
use Modules\Web3\Components\Web3\Providers\Provider;
use Modules\Web3\Components\Web3\Providers\HttpProvider;
use Modules\Web3\Components\Web3\RequestManagers\RequestManager;
use Modules\Web3\Components\Web3\RequestManagers\HttpRequestManager;
use Modules\Web3\Components\Web3\Utils;
use Modules\Web3\Components\Web3\Eth;
use Modules\Web3\Components\Web3\Contracts\Ethabi;
use Modules\Web3\Components\Web3\Contracts\Types\Address;
use Modules\Web3\Components\Web3\Contracts\Types\Boolean;
use Modules\Web3\Components\Web3\Contracts\Types\Bytes;
use Modules\Web3\Components\Web3\Contracts\Types\DynamicBytes;
use Modules\Web3\Components\Web3\Contracts\Types\Integer;
use Modules\Web3\Components\Web3\Contracts\Types\Str;
use Modules\Web3\Components\Web3\Contracts\Types\Uinteger;
...
class Contract
{
     ...
     * provider
     *
     * @var \Modules\Web3\Components\Web3\Providers\Provider
     */
    protected $provider;
     ...
     * eth
     *
     * @var \Modules\Web3\Components\Web3\Eth
     */
    protected $eth;
     ...
     * ethabi
     *
     * @var \Modules\Web3\Components\Web3\Contracts\Ethabi
     */
    protected $ethabi;
     ...
     * construct
     *
     * @param string|\Modules\Web3\Components\Web3\Providers\Provider $provider
     ...
     * getProvider
     *
     * @return \Modules\Web3\Components\Web3\Providers\Provider
     */
     ...
     * setProvider
     *
     * @param \Modules\Web3\Components\Web3\Providers\Provider $provider
     * @return $this
     */
     ...
     * getEth
     *
     * @return \Modules\Web3\Components\Web3\Eth
     */
...
//                    $data = $this->ethabi->encodeParameters($function, $params);
                    // update
                     $data = $this->ethabi->encodeParameters($function, count($params) >= 1 ? $params[0] : []);
                    $functionName = Utils::jsonMethodToString($function);
                } catch (InvalidArgumentException $e) {
                    continue;
                }
